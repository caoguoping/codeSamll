...
public:
	...
	ODSocket getOdSocket(unsigned char bSocketType);
	//pData, 只包含纯数据，不包括TCP_head
	void sendData(unsigned short wMainCmdID, unsigned short wSubCmdID, void * pData, unsigned short wDataSize);

	//pcbDataBuffer[] ,全数据， wDataSize, 全长度
