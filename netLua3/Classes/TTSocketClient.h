...
public:
	...
	bool Connect(const char* host, unsigned short port, unsigned char bSocketType);
	bool Connect(const std::string &host, unsigned char bSocketType);
	bool ConnectIPv4(const char *ip, unsigned short port, unsigned char bSocketType);
	int Send(const char* buf, int len, int flags, unsigned char bSocketType);
	int Recv(char* buf, int len, int flags, unsigned char bSocketType);
	int Close(unsigned char bSocketType);
