...
int lua_cgpCustom_TTSocketClient_startSocketLogin(lua_State* tolua_S)
{
    int argc = 0;
    TTSocketClient* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cgpCustom_TTSocketClient_startSocketLogin'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "TTSocketClient:startSocketLogin"); arg0 = arg0_tmp.c_str();

        ok &= luaval_to_ushort(tolua_S, 3, &arg1, "TTSocketClient:startSocketLogin");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cgpCustom_TTSocketClient_startSocketLogin'", nullptr);
            return 0;
        }
        cobj->startSocketLogin(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "TTSocketClient:startSocketLogin",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cgpCustom_TTSocketClient_startSocketLogin'.",&tolua_err);
#endif
...
int lua_register_cgpCustom_TTSocketClient(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"TTSocketClient");
        ...
        tolua_function(tolua_S,"startSocketLogin",lua_cgpCustom_TTSocketClient_startSocketLogin);
...
int lua_cgpCustom_DataRcv_getSubCmd(lua_State* tolua_S)
{
    int argc = 0;
    DataRcv* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cgpCustom_DataRcv_getSubCmd'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cgpCustom_DataRcv_getSubCmd'", nullptr);
            return 0;
        }
        unsigned short ret = cobj->getSubCmd();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "DataRcv:getSubCmd",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cgpCustom_DataRcv_getSubCmd'.",&tolua_err);
#endif

    return 0;
}
int lua_cgpCustom_DataRcv_getMainCmd(lua_State* tolua_S)
{
    int argc = 0;
    DataRcv* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cgpCustom_DataRcv_getMainCmd'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cgpCustom_DataRcv_getMainCmd'", nullptr);
            return 0;
        }
        unsigned short ret = cobj->getMainCmd();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "DataRcv:getMainCmd",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cgpCustom_DataRcv_getMainCmd'.",&tolua_err);
#endif
...
int lua_cgpCustom_DataRcv_create(lua_State* tolua_S)
{
    ...
    {
        const char* arg0;
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "DataRcv:create"); arg0 = arg0_tmp.c_str();
        if(!ok)
        {
...
int lua_register_cgpCustom_DataRcv(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"DataRcv");
        ...
        tolua_function(tolua_S,"getSubCmd",lua_cgpCustom_DataRcv_getSubCmd);
        tolua_function(tolua_S,"getMainCmd",lua_cgpCustom_DataRcv_getMainCmd);
